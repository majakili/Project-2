...
[AddLogsData](Images/add_logs_data.png))


Click on `System logs` 

[SystemLogs](/Images/system_logs.png)

Scroll to the bottom of the page. 
Click on `Check Data`
You should see a message highlighted in green: `Data successfully received from this module`

[SystemData](Images/system_data.png)
...
[AddMetrics](Images/add_metrics.png)

Click on `Apache Metrics` 

![ApacheMetrics](Images/apache_metrics.png)

Scroll to the bottom of the page. 
Click on `Check Data`
You should see a message highlighted in green: `Data successfully received from this module`

[ApacheMetricsData](Images/apache_metrics_data.png)
...
[AddMetricsData](Images/add_metrics_data.png)

Click on `System Metrics` 

[SystemMetrics](Images/system_metrics.png)

Scroll to the bottom of the page. 
Click on `Check Data`
You should see a message highlighted in green: `Data successfully received from this module`

[SystemMetricsData](Images/system_metrics_data.png)
...
[AddExisting](Images/add_existing.png)
